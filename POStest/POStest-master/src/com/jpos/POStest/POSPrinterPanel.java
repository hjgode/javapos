...
public class POSPrinterPanel extends Component {
    ...
    private JButton addDirectIOButton;
    ...
    class MethodListener implements ActionListener {
        public void actionPerformed(ActionEvent ae) {
            ...
            if(ae.getActionCommand().equals("open")){
                ...
                //HGO
                try {
					posPrinter.directIO(10001, new int[] {0x2,0x3,0x4 }, null);
				} catch (JposException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
            } else if(ae.getActionCommand().equals("directIO")){
                //HGO
                try {
                    if (posPrinter.getDeviceEnabled()) {               
                    	posPrinter.directIO(10001, new int[] {0x2,0x3,0x4 }, null);
                    }else {
                    	updateMessages("Printer not enabled");
                    }
				} catch (JposException e) {
					// TODO Auto-generated catch block
    ...
    class GeneralPrintingPanel extends Component {
		...
		public Component make() {
            ...
            addDirectIOButton = new JButton("DirectIO");
            addDirectIOButton.setActionCommand("directIO");
            addDirectIOButton.addActionListener(methodListener);
            ...
            insertionButtonPanel.add(addDirectIOButton);
